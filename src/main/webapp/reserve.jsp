								...
								<div class="count_people">
									<ul>
											...
											class="bx_num"><button class="btn_mins" id="Minus|10">감소</button>
												<select id="time<%=i%>" class="txt_num">
													...
													<option
														...
														(
														<%=movieTimeLists.get(j).get("nowPerson")%> /
														<%=movieTimeLists.get(j).get("maxPerson")%> )
													</option>
													<%
													}
													}
										...
										<li id="person_10" data-code="10" data-peple="성인"
											...
											class="bx_num"><button class="btn_mins" id="Minus|10">감소</button>
												<select id="personnel<%=i%>" class="txt_num">
										...
										<li><a id="goReservFunc" href='javascript:void(0);'
											onclick="javascript:reservFunc(<%=i%>);"><img
